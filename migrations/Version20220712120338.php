 ...
 */
final class Version20220712120338 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD organisateur_id INT DEFAULT NULL, ADD nb_user_current INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie DROP organisateur_id, DROP nb_user_current');
    }
}
